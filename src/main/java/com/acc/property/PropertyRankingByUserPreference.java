...
public class PropertyRankingByUserPreference {
    ...
    public static void main(String[] args) {
        ...
        String filePath = "/Users/sairarubab/Downloads/demo/page.json"; // Replace with the actual file path
        try {
            ...
            listings.sort((l1, l2) -> Integer.compare(l2.getRelevanceScore(), l1.getRelevanceScore()));

            // Display sorted listings with relevance scores
            for (PropertyListing listing : listings) {
    ...
    static class PropertyListing {
        ...
        private int id;
        private int relevanceScore; // Added this field
        ...
        // Getters and Setters including for relevanceScore
